...
public class Assets {
	...
	public static void create() {
		...
		procuderal.put("tTL", new Texture(Gdx.files.internal("textures/procuderal/path-tile-TL.png")));
		procuderal.put("tTR", new Texture(Gdx.files.internal("textures/procuderal/path-tile-TR.png")));
		procuderal.put("tBR", new Texture(Gdx.files.internal("textures/procuderal/path-tile-BR.png")));
		procuderal.put("tBL", new Texture(Gdx.files.internal("textures/procuderal/path-tile-BL.png")));
