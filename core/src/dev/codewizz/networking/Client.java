...
public class Client {
    ...
    public Client() {
        ...
        if (!connect()) {
            ...
            Logger.log("Successfully listening for network packets");
        }
    ...
    private void process(DatagramPacket packet) {
        ...
        if (data[0] == NetworkProtocol.FIRST_CONNECT) {
            Logger.log("Connected to general AoP server!");
    ...
    public void send(byte[] data) {
        ...
        try {
            ...
            Logger.error("Socket Exception! Check internet connection...");
            Logger.error(e);
        } catch (IOException e) {
            e.printStackTrace();
        }
